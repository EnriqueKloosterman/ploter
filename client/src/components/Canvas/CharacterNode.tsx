...
const CharacterNode: React.FC<NodeProps> = ({ data }) => {
  ...
  return (
    <div className={`px-4 py-3 rounded-xl shadow-lg border-2 min-w-[140px] text-center transition-all hover:shadow-xl hover:scale-105 bg-slate-800 ${color ? `border-${color}-500/60` : 'border-slate-600'}`}
